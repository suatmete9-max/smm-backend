...
export type AppOpenDefinitionsHasAllEvents = ValidateAllEventsEnumAreImplemented<AppOpenAdPluginEvents, AppOpenAdPlugin>;
export interface AppOpenAdPlugin {
     ...
     */
    isAppOpenLoaded(options?: AdShowOptions): Promise<{
        value: boolean;
    }>;
    /**
